...
export default function SignUp() {
  ...
  const handleRegister = (e) => {
    ...
    createUser(email, password,name)
      ...
      //       }
      //       else{
      //         console.log("cant post in mongodb")
      //       }
      //     });
        ...
        <fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-xs border p-4 my-8">
          ...
          <div className="relative">
            ...
            <input
              name="name"
              type="text"
              className="input my-1 pl-8 rounded-4xl focus:outline-none"
          ...
          <div className="relative">
            ...
            <input
              ...
              className="focus:outline-none pl-8 input my-1 rounded-4xl"
            ...
            <span
              ...
              className="cursor-pointer absolute z-20 text-gray-500 right-4 top-1/2 -translate-y-1/2"
            >
              {showConfirmPassword ? (
                <Eye size={16} />
              ) : (
          ...
          <ToastContainer
            closeButton={false}
            toastClassName={() =>
              "flex items-center bg-black text-white shadow rounded-3xl text-sm py-3 px-4"
            }
          />
        </fieldset>
      </form>
